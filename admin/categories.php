                    ...
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            if(isset($_POST['btn_category']))
                            {
                                ...
                                {                                
                                    ...
                                    $Add_Sub_Cat = $_POST['sub-category'];
                                    $query ="insert into categories (cat_title,cat_sub) values('$Add_Cat','$Add_Sub_Cat')";
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sub-category" placeholder="Sub-Category" class="form-control mb-2">
                            </div>
                            <div class="form-group">
                        ...
                        <form action="update.php" method="POST" >
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_sub_category" value="<?php echo $data['cat_sub']; ?>" placeholder="Sub-Category" class="form-control mb-2">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th style="width:50%;"> Sub Category Name </th>
                            ...
                            ?>
                                ...
                                <td> <a href="categories.php?edit=<?php echo $row['cat_id']; ?>" class="btn btn-info"><span class="fa fa-edit"></span></a> </td>
                            </tr>
                            <?php
                            }
