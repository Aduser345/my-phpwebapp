<table class="table table-stripped">
                        ...
                        ?>
                            ...
                            <td><img width="50" height="50" class="img-responsive" src="../images/<?php echo $row['post_img']?>"></td>
                            <td><?php echo $row['post_date']?></td>
                            <td><a href="./posts.php?del=<?php echo $row['post_id']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span></a></td>
                            <td><a href="./posts.php?opt=edit_post&p_id=<?php echo $row['post_id']; ?>" class="btn btn-info"><span class="fa fa-edit"></span></a></td>
                            </tr>
                        <?php       
                            }
                        ?>                            
